...
if($lloo_op['type'] == 'button'){
		...
		$styles['height'] = $lloo_op['height'].'px';
			...
			$styles['background'] = 'transparent url('.$pluginUrl.'img/up-'.$lloo_op['button_arrow'].'.png) no-repeat '.$paddingLeft.' '.$topBg.'px';
			$tplOptions['upBg'] = $styles['background'];
			$tplOptions['downBg'] = 'transparent url('.$pluginUrl.'img/down-'.$lloo_op['button_arrow'].'.png) no-repeat '.$paddingLeft.' '.$topBg.'px';
			}
			else
			{
			$styles['background'] = $lloo_op['background_color'].' url('.$pluginUrl.'img/up-'.$lloo_op['button_arrow'].'.png) no-repeat '.$paddingLeft.' '.$topBg.'px';
			$tplOptions['upBg'] = $styles['background'];
			$tplOptions['downBg'] = $lloo_op['background_color'].' url('.$pluginUrl.'img/down-'.$lloo_op['button_arrow'].'.png) no-repeat '.$paddingLeft.' '.$topBg.'px';
			}
