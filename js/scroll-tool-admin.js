...
jQuery(document).ready(function($) {
	...
	if($( "#scroll-button" ).prop( "checked" )){
		...
		if($( "#scroll-transparent-bg" ).prop( "checked" )){
		scrollObject.css('background', 'transparent url(../wp-content/plugins/scroll-tool/img/up-'+$("input[name='scroll_tool[button_arrow]']:checked").val()+'.png) no-repeat '+paddingLeft+' '+topBg+'px');
		}
		else
		{
		scrollObject.css('background', $("#scroll-background-color").val()+' url(../wp-content/plugins/scroll-tool/img/up-'+$("input[name='scroll_tool[button_arrow]']:checked").val()+'.png) no-repeat '+paddingLeft+' '+topBg+'px');	
		}
	...
	if(showAdjScroll){
		if(animatedScroll){
			...
			scrollHeight = $(document).scrollTop();
				...
				if($( "#scroll-display-labels" ).prop( "checked" ))
				$('#scroll-object div').html($('#scroll-text-up').val());
				$('#scroll-object').css('background-image', 'url(../wp-content/plugins/scroll-tool/img/up-'+$("input[name='scroll_tool[button_arrow]']:checked").val()+'.png)');
				}
			...
			else
			{
				$('#scroll-object').click(
					function (e) {
						...
						$('#scroll-object').css('background-image', 'url(../wp-content/plugins/scroll-tool/img/down-'+$("input[name='scroll_tool[button_arrow]']:checked").val()+'.png)');
